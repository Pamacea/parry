...
use crate::autofix::rules::{FixRule, FixRuleRegistry};
...
pub enum FixRuleWrapper {
    Tailwind(crate::autofix::rules::TailwindFixRule),
    Import(crate::autofix::rules::ImportFixRule),
    React(crate::autofix::rules::ReactFixRule),
    Css(crate::autofix::rules::CssFixRule),
}
